...
## EDUCATION
- 네이버 커넥트재단 부스트캠프 웹・모바일 8기 멤버십 - 웹/백엔드(2023.08.28 ~ 2023.12.15)
- 네이버 커넥트재단 부스트캠프 웹・모바일 8기 챌린지 - 웹/백엔드(2023.07.10 ~ 2023.08.04)
- 한국공학대학교(구 한국산업기술대학교) 전자공학부 임베디드시스템 전공(2018.03 ~ 2026.02)
